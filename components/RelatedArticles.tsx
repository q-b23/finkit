...
const RELATED: Record<string, Article[]> = {
  ...
  mortgage: [
    ...
    },
    {
      ...
      title: "Hidden Housing Costs",
      description: "Property tax, insurance, HOA, maintenance — the true monthly cost.",
      tag: "Housing",
      tagColor: "bg-purple-50 text-purple-700",
    },
    {
      href: "/should-i-buy-a-house",
      title: "Should I Buy a House?",
      description: "The 4 questions to answer before you look at a single listing.",
      tag: "Buying",
